component name="Stripe" output=false accessors=true description="ColdFusion Wrapper for Stripe.com" {
	
    /* ColdFusion wrapper for Stripe.com API */
    /* Written by James Eisenlohr */
